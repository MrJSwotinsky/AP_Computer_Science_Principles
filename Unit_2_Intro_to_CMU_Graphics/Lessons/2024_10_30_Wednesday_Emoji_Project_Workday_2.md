...
### Emoji Project Workday #2

**AIM(s):** <br>
How can I complete a first draft of my emoji project? <br><br>
...
<table>
  <tr>
    <td>
      <b>DO NOW:</b><br>
      1. Open your project code file <br>
      2. Using the paper handout, self assess which of the project elements you have used already. Which do you have left to code? <br><br>
</td>
</tr>
</table>
...
**AGENDA:**
1. Do Now 
2. Finish your first draft of your project. It doesnt have to be perfect yet. 
    - Consider: Did you use all the elements on the checklist?
    - Is each line of code or chunk of code explained by a comment? <br><br>
If you're having trouble coming up with the coordinates, use the grid on the Do Now handout, or paste the following code into your IDLE to draw gridlines under your project: <br>
...
**HOMEWORK:**
1. Work on your project, making at least 5 commits. For one of your commits, implement the feedback you got from your peer at the end of class.
