...
**AIM(s):** <br>
How can we apply what we have learned about generating and customizing shapes in CMU Graphics to code an Emoji that represents us?
...
**SUCCESS CRITERIA:**
- [ ] I can describe the expectations of the Emoji project.
- [ ] I can leverage version history to iteratively develop my work.
- [ ] I can leverage commit messages to document my work progress and next steps.
...
1. Emoji Project Shareout
2. Emoji Project Launch  
3. Developing Version History
   * Updating code.
   * Updating images
   * Documenting updates.
